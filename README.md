...
<---------ホワイトボックステスト---------><br>
・開発者視点のテスト<br>
・すべてのプログラムが意図したとおりに動作しているかを確認する<br>
・テスト項目は詳細設計書を基に作成する
<---------ブラックボックステスト---------><br>
・ユーザー視点のテスト<br>
・システム自体の仕様を満たしているかどうかを確認する<br>
・プログラムの内部構造を考慮せずに、外部から網羅的にチェックする<br>
・画面表示の不具合やレイアウト崩れなど、正しい出力ができているか確認する<br>
<---------グレーボックステスト---------><br>
・ホワイトボックステストとブラックボックステストの中間
・内部構造を理解した上で外部からの機能や仕様を確認する
・内部の構造についてよく理解しているプログラム作成者がテスト実施する

■結合テスト（IT:IntegrationTest）<br>

■システムテスト（ST:System Test）<br>
